    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white">
      ...
      <section className="relative bg-white/5 backdrop-blur-lg border-t border-white/10 py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl lg:text-4xl text-center mb-12 font-semibold text-white">Features</h2>
          <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory px-2 py-4">

            <div className="snap-start flex-shrink-0 w-80 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl mb-2 text-center">Emotion-Powered</h3>
              <p className="text-purple-200 text-center">Choose from moods: Bored, Happy, Stressed, Sad, Motivated</p>
            </div>
            ...
            <div className="snap-start flex-shrink-0 w-80 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer">
              ...
              <p className="text-purple-200 text-center">AI-selected movies tuned to your emotional state</p>
            </div>
            ...
            <div className="snap-start flex-shrink-0 w-80 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer">
              ...
              <p className="text-purple-200 text-center">View cast, ratings, reviews, summaries & more</p>
            </div>
      ...
      <section className="relative container mx-auto px-4 py-16 lg:py-24">
        <h2 className="text-3xl lg:text-4xl text-center mb-12 font-semibold text-white">How It Works</h2>
        <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory px-2 py-4">

          <div className="snap-start flex-shrink-0 w-64 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer text-center">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">1</div>
            <h3 className="text-xl mb-2">Choose Your Mood</h3>
            <p className="text-purple-200">Tell us how you feel</p>
          </div>

          <div className="snap-start flex-shrink-0 w-64 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer text-center">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">2</div>
            <h3 className="text-xl mb-2">Get Recommendations</h3>
            <p className="text-purple-200">AI-powered mood-matching movies</p>
          </div>

          <div className="snap-start flex-shrink-0 w-64 p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 hover:scale-105 transition-transform duration-300 cursor-pointer text-center">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">3</div>
            <h3 className="text-xl mb-2">Start Watching</h3>
            <p className="text-purple-200">Enjoy your personalized film</p>
          </div>
